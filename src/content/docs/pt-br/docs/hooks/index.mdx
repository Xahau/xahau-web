...
> _To learn more about the theoretical concepts of Hooks you can visit the_ [_Concepts_](/pt-br/docs/hooks/concepts/introduction) _section._

> _To learn how to code Hooks in C and its functions, visit_ [_Hooks C-Functions_](/pt-br/docs/hooks/functions/overview/hook-api-conventions/)_._

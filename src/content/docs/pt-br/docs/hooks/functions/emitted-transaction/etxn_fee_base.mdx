...
<Aside type="caution">
Fees on a Hooks-enabled ledger are non trivial. See: [Hook Fees](/pt-br/docs/hooks/concepts/hook-fees) for details.
</Aside>

### Concepts

<LinkButton href="/pt-br/docs/hooks/concepts/emitted-transactions">Emitted Transactions</LinkButton>

...
| -------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| [slot](/pt-br/docs/hooks/functions/slot/slot)                    | Serialize and output a slotted object                                                  |
| [slot_clear](/pt-br/docs/hooks/functions/slot/slot_clear)       | Free up a currently occupied slot                                                      |
| [slot_count](/pt-br/docs/hooks/functions/slot/slot_count)       | Count the elements of an array object in a slot                                        |
| slot_id                                                             | Compute the canonical hash of the slotted object and return it                         |
| [slot_set](/pt-br/docs/hooks/functions/slot/slot_set)           | Locate an object based on its keylet and place it into a slot                          |
| [slot_subarray](/pt-br/docs/hooks/functions/slot/slot_subarray) | Index into a slotted array and assign a sub-object to another slot                     |
| [slot_subfield](/pt-br/docs/hooks/functions/slot/slot_subfield) | Index into a slotted object and assign a sub-object to another slot                    |
| [slot_type](/pt-br/docs/hooks/functions/slot/slot_type)         | Retrieve the field code of an object in a slot and, optionally, some other information |
| [slot_float](/pt-br/docs/hooks/functions/slot/slot_float)       | Parse the STI_AMOUNT in the specified slot and return it as an XFL enclosed number    |
| [slot_size](/pt-br/docs/hooks/functions/slot/slot_size)         | Compute the serialized size of an object in a slot                                     |
...
Hooks use a serialized 34 byte keylet format which can be derrived using the important [util_keylet](/pt-br/docs/hooks/functions/utilities/util_keylet) function. Without this looking up and slotting objects would be generally impossible.

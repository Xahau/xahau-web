...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [trace](/pt-br/docs/hooks/functions/trace-debug/trace)              | Print a utf-8 message, followed by a user-specified buffer (this last optionally as hex.) |
| [trace_num](/pt-br/docs/hooks/functions/trace-debug/trace_num)     | Print a utf-8 message, followed by an integer.                                            |
| [trace_float](/pt-br/docs/hooks/functions/trace-debug/trace_float) | Print a utf-8 message, followed by an XFL Floating point number.                          |

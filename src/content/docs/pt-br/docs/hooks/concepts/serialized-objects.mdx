...
| Hook API                                                                    | at it does                                                                            |
| --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [sto_subfield](/pt-br/docs/hooks/functions/serialization/sto_subfield) | Index into a xrpld serialized object and return the location and length of a subfield |
| [sto_subarray](/pt-br/docs/hooks/functions/serialization/sto_subarray) | Index into a xrpld serialized array and return the location and length of an index    |
| [sto_emplace](/pt-br/docs/hooks/functions/serialization/sto_emplace)   | Emplace a field into an existing STObject at its canonical placement                  |
| [sto_erase](/pt-br/docs/hooks/functions/serialization/sto_erase)       | Remove a field from an STObject                                                       |
| [sto_validate](/pt-br/docs/hooks/functions/serialization/sto_validate) | Validate an STObject                                                                  |

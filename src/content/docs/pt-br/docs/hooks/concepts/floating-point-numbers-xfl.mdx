...
| ----------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [float_set](/pt-br/docs/hooks/functions/float/float_set)           | Create a float from an exponent and mantissa                          |
| [float_multiply](/pt-br/docs/hooks/functions/float/float_multiply) | Multiply two XFL numbers together                                     |
| [float_mulratio](/pt-br/docs/hooks/functions/float/float_mulratio) | Multiply an XFL floating point by a non-XFL numerator and denominator |
| [float_negate](/pt-br/docs/hooks/functions/float/float_negate)     | Negate an XFL floating point number                                   |
| [float_compare](/pt-br/docs/hooks/functions/float/float_compare)   | Perform a comparison on two XFL floating point numbers                |
| [float_sum](/pt-br/docs/hooks/functions/float/float_sum)           | Add two XFL numbers together                                          |
| [float_sto](/pt-br/docs/hooks/functions/float/float_sto)           | Output an XFL as a serialized object                                  |
| [float_sto_set](/pt-br/docs/hooks/functions/float/float_sto_set)  | Read a serialized amount into an XFL                                  |
| [float_invert](/pt-br/docs/hooks/functions/float/float_invert)     | Divide one by an XFL floating point number                            |
| [float_divide](/pt-br/docs/hooks/functions/float/float_divide)     | Divide an XFL by another XFL floating point number                    |
| [float_one](/pt-br/docs/hooks/functions/float/float_one)           | Return the number 1 represented in an XFL enclosing number            |
| [float_exponent](/pt-br/docs/hooks/functions/float/float_exponent) | Get the exponent of an XFL enclosing number                           |
| [float_mantissa](/pt-br/docs/hooks/functions/float/float_mantissa) | Get the mantissa of an XFL enclosing number                           |
| [float_sign](/pt-br/docs/hooks/functions/float/float_sign)         | Get the sign of an XFL enclosing number                               |
...
| [float_int](/pt-br/docs/hooks/functions/float/float_int)           | Convert an XFL floating point into an integer floor                 |
| [float_root](/pt-br/docs/hooks/functions/float/float_root)         | Compute the nth root of an XFL                                        |
| [float_log](/pt-br/docs/hooks/functions/float/float_log)           | Compute the decimal log of an XFL                                     |

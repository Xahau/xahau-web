...
| sfHookEmitCount        | The total number of [Emitted Transactions](/pt-br/docs/hooks/concepts/emitted-transactions) produced by the Hook.                                                                    |
...
| sfHookStateChangeCount | The number of [Hook State](/pt-br/docs/hooks/concepts/state-management) changes the Hook made during execution.                                                                      |

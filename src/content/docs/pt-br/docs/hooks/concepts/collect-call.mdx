...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><strong>Again As Weak</strong><br />- Happens when a Strongly Executed Hook calls <a href="/pt-br/docs/hooks/functions/hook-context/hook_again">hook_again</a></p>  | Free (already paid by the Strong Execution).                                                                                                                                           |

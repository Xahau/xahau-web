...
4. Uma abordagem proativa para atualizar e votar em [emendas](/docs/features/amendments) e taxas
...
7. Cole o `attestation=""` em seu arquivo [TOML](/docs/infrastructure/identity) para provar a identidade do seu validador.

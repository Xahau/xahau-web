...
<Aside type="caution">
Criar um ambiente para compilar o xahaud pode causar danos permanentes ao sistema. A seção [Ambientes de Compilação](#ambientes-de-compilação-para-iniciantes) desta página contém técnicas para isolar seu ambiente de compilação do sistema operacional subjacente. Realize alterações no sistema por sua conta e risco.
</Aside>

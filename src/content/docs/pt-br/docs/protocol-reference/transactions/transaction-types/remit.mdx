...
| Campo    | Tipo JSON                                                                                                                          | \[Tipo Interno]\[] | Descrição                                                                    |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------------------------------------------------------------------- |
| `Amount` | [Valor de Moeda](/pt-br/docs/protocol-reference/data-types/currency-formats/#especificando-valores-em-moeda) | Amount             | O valor da moeda que a conta deseja enviar ao `Destination`. |

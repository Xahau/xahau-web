...
| `Amount`      | [Valor em Moeda](/pt-br/docs/protocol-reference/data-types/currency-formats/#especificando-valores-em-moeda) | Amount              | _(Opcional)_ O valor da moeda que a conta deseja receber em troca do URIToken.                |

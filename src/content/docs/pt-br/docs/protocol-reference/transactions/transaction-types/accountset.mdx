...
* Nesse domínio, hospede um arquivo [xahau.toml](/pt-br/docs/infrastructure/identity) listando as contas que você possui e, opcionalmente, outras informações sobre como você usa o Xahau.

...
Consulte [Conta Alta vs. Conta Baixa](/pt-br/docs/protocol-reference/ledger-data/ledger-objects-types/ripple-state#conta-alta-vs-conta-baixa) para informações sobre como as contas baixa e alta são determinadas.

...
| `TakerGets`     | [Valor em Moeda](/pt-br/docs/protocol-reference/data-types/currency-formats/#especificando-valores-em-moeda) | Amount              | O valor e o tipo de moeda sendo vendida.                                                               |
| `TakerPays`     | [Valor em Moeda](/pt-br/docs/protocol-reference/data-types/currency-formats/#especificando-valores-em-moeda) | Amount              | O valor e o tipo de moeda sendo comprada.                                                              |

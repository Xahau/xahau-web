...
| `TakerGets`     | [Valor em Moeda](/docs/protocol-reference/data-types/currency-formats/#specifying-currency-amounts) | Amount              | O valor e o tipo de moeda sendo vendida.                                                               |
| `TakerPays`     | [Valor em Moeda](/docs/protocol-reference/data-types/currency-formats/#specifying-currency-amounts) | Amount              | O valor e o tipo de moeda sendo comprada.                                                              |

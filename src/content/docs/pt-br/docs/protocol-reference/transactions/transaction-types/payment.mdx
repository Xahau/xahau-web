...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Amount`         | [Valor de Moeda](/pt-br/docs/protocol-reference/data-types/currency-formats/#especificando-valores-em-moeda) | Amount              | A quantidade de moeda a ser entregue. Para valores não-XAH, os nomes dos campos aninhados DEVEM estar em letras minúsculas. Se a flag `tfPartialPayment` estiver definida, entrega _até_ esse valor em vez do exato.                                                                                                                                                                                                                            |

...
Se você acredita ter encontrado um bug relacionado à segurança, notifique-nos o mais rápido possível enviando uma **descrição de alto nível da sua descoberta e informações de contato (para que alguém possa retornar)** por e-mail para [bugs@xahau.network](mailto:bugs@xahau.network).

Se o problema estiver relacionado ao **xahaud**, consulte a política de segurança dele: [https://github.com/Xahau/xahaud?tab=security-ov-file](https://github.com/Xahau/xahaud?tab=security-ov-file)

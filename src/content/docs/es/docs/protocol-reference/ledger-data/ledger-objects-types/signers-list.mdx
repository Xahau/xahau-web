...
| `WalletLocator` | String    | Hash256       | _(Opcional)_ Datos hexadecimales arbitrarios. Pueden usarse para identificar al firmante u otros propósitos relacionados. _(Añadido por la enmienda \[ExpandedSignerList]\[].)_   |

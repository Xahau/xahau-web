...
Un objeto `Cron` representa una ejecución programada de Hook creada por una [transacción CronSet](/docs/protocol-reference/transactions/transaction-types/cronset). El motor Cron inserta automáticamente pseudo-transacciones de tipo `Cron` en el ledger cuando las ejecuciones programadas están pendientes.
...
* [Transacción CronSet](/docs/protocol-reference/transactions/transaction-types/cronset): Crea, actualiza o elimina un objeto Cron

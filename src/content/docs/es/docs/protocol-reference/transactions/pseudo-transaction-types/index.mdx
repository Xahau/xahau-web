...
| `Flags`           | Number    | UInt32              | _(Opcional)_ Un conjunto de indicadores de bits para esta transacción. El significado de los indicadores específicos varía según el tipo de transacción. |

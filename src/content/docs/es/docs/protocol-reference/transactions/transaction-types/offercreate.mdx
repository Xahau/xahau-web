...
| `TakerGets`     | [Monto de Moneda](/docs/protocol-reference/data-types/currency-formats/#specifying-currency-amounts) | Amount              | La cantidad y tipo de moneda que se vende.                                                            |
| `TakerPays`     | [Monto de Moneda](/docs/protocol-reference/data-types/currency-formats/#specifying-currency-amounts) | Amount              | La cantidad y tipo de moneda que se compra.                                                           |

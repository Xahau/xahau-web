...
description: >-
  Una transacción DepositPreauth otorga pre-aprobación a otra cuenta para
  entregar pagos al emisor de esta transacción.
---
...
| ------------- | --------- | ------------------- | -------------------------------------------------------------------------------- |
| `Authorize`   | String    | AccountID           | _(Opcional)_ Dirección Xahau del emisor a preautorizar.                          |
| `Unauthorize` | String    | AccountID           | _(Opcional)_ Dirección Xahau de un emisor cuya preautorización debe revocarse.   |

Debe proporcionar _`Authorize`_ o _`Unauthorize`_, pero no ambos.

...
title: SignerListSet
description: >-
  La transacción SignerListSet crea, reemplaza o elimina una lista de firmantes
  que puede usarse para firmar múltiplemente una transacción.
---

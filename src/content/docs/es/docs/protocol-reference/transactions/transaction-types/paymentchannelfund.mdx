...
| `Amount`     | [Monto de Moneda](/docs/protocol-reference/data-types/currency-formats/#specifying-currency-amounts) | Amount              | Monto a agregar al canal. Debe ser una cantidad positiva.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |

...
title: SetRemarks
description: >-
  La transacción SetRemarks permite a las cuentas adjuntar, actualizar o eliminar
  observaciones arbitrarias (pares clave-valor) en objetos ledger admitidos.
---
\[[Source](https://github.com/Xahau/xahaud/blob/dev/src/ripple/app/tx/impl/SetRemarks.cpp)]

_(Añadido por la enmienda \[Remarks]\[].)_

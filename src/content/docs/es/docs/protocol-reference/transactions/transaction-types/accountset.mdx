...
* En ese dominio, aloje un archivo [xahau.toml](/docs/infrastructure/identity) que liste las cuentas que posee, y opcionalmente otra información sobre cómo usa Xahau.

...
| `Amount`      | [Monto de Moneda](/es/docs/protocol-reference/data-types/currency-formats/#specifying-currency-amounts) | Amount              | _(Opcional)_ La cantidad de moneda que la cuenta quiere recibir a cambio del URIToken.         |

...
title: AccountDelete
description: >-
  Una transacción AccountDelete elimina una cuenta y cualquier objeto que posea en
  Xahau, si es posible, enviando el XAH restante de la cuenta a una cuenta de
...
| `DestinationTag` | Number                 | UInt32              | _(Opcional)_ Etiqueta de destino arbitraria que identifica un destinatario alojado u otra información para el receptor del XAH sobrante de la cuenta eliminada.        |

...
### Especificando Montos de Moneda {#specifying-currency-amounts}
...
Para especificar una cantidad de XAH, usa un número de tipo String que indique _drops_ de XAH, donde cada drop equivale a 0.000001 XAH. Por ejemplo, para especificar 13.1 XAH:
...
Para describir XAH sin una cantidad, especifícalo como un objeto JSON con _solo_ un campo `currency`. Nunca incluyas un campo `issuer` para XAH. Por ejemplo:

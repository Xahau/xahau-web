...
<h3 id="addresses">Direcciones</h3>
...
<h3 id="ledger-index">Índice de Ledger</h3>
...
También hay un parámetro `ledger` obsoleto que acepta cualquiera de los tres formatos anteriores. _No_ uses este parámetro; puede eliminarse sin previo aviso.

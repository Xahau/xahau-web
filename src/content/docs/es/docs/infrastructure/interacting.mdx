...
Para habilitar puertos de escucha, edita el archivo `xahaud.cfg`. Los puertos habilitados se enumeran en la sección `[server]` del archivo de configuración. Cada puerto listado bajo la sección `[server]` debe definirse además mediante su propia sección.
...
admin = [ 10.10.10.5, 10.11.11.0/24 ] # Direcciones IP o subredes autorizadas para enviar solicitudes [admin](/docs/features/http-websocket-apis/admin-api-methods).

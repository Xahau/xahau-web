...
* Las compilaciones suelen probarse en Ubuntu LTS, pero Docker, binarios portables y builds personalizados permiten soporte para múltiples sistemas operativos.

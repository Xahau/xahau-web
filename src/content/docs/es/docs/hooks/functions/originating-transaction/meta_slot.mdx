...
* Si el Hook se está ejecutando de forma [débil (Weak Execution)](/docs/hooks/concepts/weak-and-strong), coloca los metadatos de la transacción origen en el slot especificado o en uno nuevo si no se especifica ninguno

...
* Si el hook se está ejecutando en modo fuerte, marca este hook en la cadena para [Again As Weak Execution](/docs/hooks/concepts/weak-and-strong).
...
<TabItem label="JavaScript">
```javascript id="hook-again-js-ex"

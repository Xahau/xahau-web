...
| Hook API                                                                | Qué hace                                                                                  |
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [trace](/docs/hooks/functions/trace-debug/trace)              | Imprime un mensaje en utf-8, seguido de un buffer especificado por el usuario (este último opcionalmente en hexadecimal). |
| [trace_num](/docs/hooks/functions/trace-debug/trace_num)     | Imprime un mensaje en utf-8, seguido de un entero.                                        |
| [trace_float](/docs/hooks/functions/trace-debug/trace_float) | Imprime un mensaje en utf-8, seguido de un número de punto flotante XFL.                  |

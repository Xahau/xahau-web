...
El siguiente ejemplo utiliza la API [state_set](/docs/hooks/functions/state/state_set) para asignar el valor `0xC001CAFE` a la clave `0x0..000001` (uint256 = 1) en el estado del Hook de la cuenta:
...
Consulta [Namespaces](/docs/hooks/concepts/namespaces)
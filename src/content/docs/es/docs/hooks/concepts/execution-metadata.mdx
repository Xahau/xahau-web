...
| sfHookEmitCount        | El número total de [Transacciones emitidas](/docs/hooks/concepts/emitted-transactions) producidas por el Hook.                                              |
...
| sfHookStateChangeCount | El número de cambios de [estado del Hook](/docs/hooks/concepts/state-management) realizados durante la ejecución.                                            |
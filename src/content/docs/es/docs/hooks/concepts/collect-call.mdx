...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <p><strong>Again As Weak</strong><br />- Ocurre cuando un Hook ejecutado de forma fuerte llama a <a href="/docs/hooks/functions/hook-context/hook_again">hook_again</a></p> | Gratis (ya pagado durante la ejecución fuerte).                                                                                                                                       |

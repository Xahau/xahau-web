...
description: >-
  ...
  available every ledger via entropy_cr_dice() and entropy_cr_random() hook API functions.
---
...
#### entropy_cr_dice(sides, min_tier)
...
| Application | Suggested `min_tier` | Additional policy via `entropy_cr_status()` |
|-------------|---------------------|------------------------------------------|
...
<LinkCard title="entropy_cr_dice() Reference" href="/docs/hooks/functions/utilities/entropy-cr-dice" />
<LinkCard title="entropy_cr_random() Reference" href="/docs/hooks/functions/utilities/entropy-cr-random" />
<LinkCard title="entropy_cr_status() Reference" href="/docs/hooks/functions/utilities/entropy-cr-status" />

...
If you believe you have found a security-related bug, please notify us as soon as possible by emailing a **high level description of your finding and contact information (so someone can reach out)** to [bugs@xahau.network](mailto:bugs@xahau.network).

If the issue is related to **xahaud**, please refer to its security policy: [https://github.com/Xahau/xahaud?tab=security-ov-file](https://github.com/Xahau/xahaud?tab=security-ov-file)

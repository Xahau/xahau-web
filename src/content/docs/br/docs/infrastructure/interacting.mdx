...
admin = [ 10.10.10.5, 10.11.11.0/24 ] # Endereços IP ou sub-redes permitidos para enviar requisições de [admin](/docs/features/http-websocket-apis/admin-api-methods).

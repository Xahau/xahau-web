...
export const roadmapTranslations = {
  ...
  labels: {
    ...
    es: {
      ...
      subtitle:
        'Red empresarial con adiciones mínimas de funciones, máxima fiabilidad',
      statement:
        'Xahau es una Blockchain Layer-1 de <em>Grado Empresarial</em>. Los cambios de protocolo son deliberados y escasos. La mayor parte del trabajo está en los <em>despliegues</em>: auditorías, integraciones y alianzas que ponen la red en manos de usuarios reales. Los elementos aquí listados son orientativos y están sujetos a cambios. Esta hoja de ruta cubre actualmente solo el desarrollo principal y las actividades compartidas por INFTF.',
      kpis: {

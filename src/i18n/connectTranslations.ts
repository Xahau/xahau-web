export const connectTranslations = {
  events: [
    {
      ...
      location: {
        ...
        mapsUrl:
          'https://www.google.com/maps/place/MIL+(+Madrid+Innovation+Lab+)/@40.434491,-3.7064685,906m/data=!3m1!1e3!4m6!3m5!1s0xd4229d08548c999:0x5f5190cb07369de2!8m2!3d40.4366246!4d-3.7048174!16s%2Fg%2F11snptdnc1',
      },
      speakers: [],
      registration: {
      ...
      description: {
        ...
        ja: 'Xahauブロックチェーンプログラミングの無料入門コースです。この4時間の対面コースは、実践的な演習を通じて基本的な概念とツールを学ぶことに焦点を当てています。非EVM代替手段に興味を持つ開発者、起業家、またはブロックチェーンの経験がない方を対象としています。言語：スペイン語・英語。',
      },
    },
    {
  ...
  about: {
    body: {
      ...
      ja: 'Xahau Connectは、INFTF（Inclusive Financial Technology Foundation）が主催する専門的なブロックチェーンイベントシリーズです。ブロックチェーン技術とその実世界への応用について、真剣かつ非特定的な議論を促進することを目的としています。',
    },
    mission: [
      {
        title: {
